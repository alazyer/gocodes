...
var foosResource = schema.GroupVersionResource{Group: "auth.alazyer.io", Version: "v1alpha1", Resource: "foos"}

var foosKind = schema.GroupVersionKind{Group: "auth.alazyer.io", Version: "v1alpha1", Kind: "Foo"}
