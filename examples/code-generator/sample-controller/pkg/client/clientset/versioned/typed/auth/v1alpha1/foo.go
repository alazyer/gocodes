...
import (
	...
	scheme "github.com/alazyer/gocodes/examples/code-generator/sample-controller/pkg/client/clientset/versioned/scheme"
...
func newFoos(c *AuthV1alpha1Client) *foos {
	return &foos{
		client: c.RESTClient(),
	}
}
