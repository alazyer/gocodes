...
import (
	v1alpha1 "github.com/alazyer/gocodes/examples/code-generator/sample-controller/pkg/apis/samplecontroller/v1alpha1"
...
var foosResource = schema.GroupVersionResource{Group: "samplecontroller.alazyer.io", Version: "v1alpha1", Resource: "foos"}

var foosKind = schema.GroupVersionKind{Group: "samplecontroller.alazyer.io", Version: "v1alpha1", Kind: "Foo"}
...
func (c *FakeFoos) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(foosResource, name), &v1alpha1.Foo{})
	return err
}
