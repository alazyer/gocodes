...
import (
	...
	samplecontrollerv1alpha1 "github.com/alazyer/gocodes/examples/code-generator/sample-controller/pkg/apis/samplecontroller/v1alpha1"
	...
	v1alpha1 "github.com/alazyer/gocodes/examples/code-generator/sample-controller/pkg/client/listers/samplecontroller/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.SamplecontrollerV1alpha1().Foos().List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SamplecontrollerV1alpha1().Foos().Watch(options)
			},
		},
